...
contract("Fundraiser", accounts => {
    ...
    // This address will be receiving the funds
    const beneficiary = accounts[1];
    // This address acts as Coinbase or any currency exchange. It will not be receiving any funds
